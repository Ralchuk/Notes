...
const headerNote = 'flex flex-row gap-[15px]';
...
const formCross = 'flex justify-end text-[#1976d3] cursor-pointer';
    ...
    <div className={container}>
      <div className={noteContainer}>
        <div className={headerNote}>
          ...
          <button className={btnClear} onClick={onClean}>Clear</button>
        </div>
        {isOpen ?
        <div className={formContainer}>
          <button className={formCross} onClick={() => setIsOpen(false)}>
